...
- `SiteFooter`: identita, colonne di link, social, trust badge e dati societari. I badge seguono l'ordine iubenda, Google Partner (link al profilo in nuova scheda), Brevo, WooCommerce; WooCommerce e ridotto del 15% circa per bilanciare il peso visivo. Il watermark e un'eccezione controllata del footer.
