...
export const serviceCards = [
  ['Siti web ed ecommerce', 'Siti istituzionali, piattaforme, cataloghi e commercio digitale con contenuti chiari e performance solide.', cmsMedia.projects.albertini],
  ['Marketing digitale', 'SEO, advertising, social e contenuti organizzati dentro un piano misurabile e continuativo.', '/media/marketing-digitale.png'],
  ['Brand e comunicazione', "Identità, messaggi, materiali coordinati e campagne capaci di rendere riconoscibile l'azienda.", cmsMedia.projects.progettoe],
  ['Pubblicità tradizionale', 'Media planning, materiali stampati, iniziative promozionali e concorsi a premi collegati al digitale.', cmsMedia.projects.sireneBlu]
